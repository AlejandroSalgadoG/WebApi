...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_filter_by_tags(self):
        recipe1 = create_recipe(user=self.user, title="vegetables")
        tag1 = Tag.objects.create(user=self.user, name="vegan")
        recipe1.tags.add(tag1)

        recipe2 = create_recipe(user=self.user, title="eggs")
    ...
    def test_filter_by_ingredients(self):
        recipe1 = create_recipe(user=self.user, title="beans")
        ingredient1 = Ingredient.objects.create(user=self.user, name="beans")
        recipe1.ingredients.add(ingredient1)

        recipe2 = create_recipe(user=self.user, title="chiken")
